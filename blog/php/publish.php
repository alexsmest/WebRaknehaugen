    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <div class="col-md-9 post-content" data-aos="fade-up">
                ...
                <div class="post-meta"><span class="date">$author</span> <span class="mx-1">&bullet;</span>
                    <span>$date</span></div>
                <h1 class="mb-5">$title</h1>
                <p>$undertitle</p>

                <figure class="my-4">
                    <img src="../../images/$category/$title.jpg" alt="" class="img-fluid">
...
$newPost = fopen("../posts/$category/$title.html", "w");
fwrite($newPost, $content);
fclose($newPost);

move_uploaded_file($image["tmp_name"], "../images/$category/$title.jpg");
